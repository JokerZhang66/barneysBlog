...
{{< admonition>}}
neovim的官方安装文档:{{<link "https://github.com/neovim/neovim/wiki/Installing-Neovim">}}
{{< /admonition >}}


## 安装nvim

1.使用命令在服务器上安装`neovim`,服务器系统是`centos7`
...
4.编辑`init.vim`文件,在该文件中加入`vim-plug`配置部分
...
5.退出编辑`init.vim`,重新打开`nvim`,输入命令安装插件

```shell
:PlugInstall 
```

6.在`init.vim`中添加官方推荐的配置内容
