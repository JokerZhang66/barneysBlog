...
{{< image src="/images//img/20220210221421.png" caption="">}}
...
password: root
url: memo
featuredImage: /images//img/20220211100004.png
```
...
<a href="">查看 SVG 文件</a>
<object data="/svgs/gitee.svg" type=""></object>

### 18.插入的b站视频开启最高画质

{{< bilibili BV1n441127jG >}}
...
### 20.docker上的mysql数据库root密码
与电脑开机密码相同

### 21.git-bash如何修复不显示历史命令

**问题:** git-bash按上下键没有找到之前使用过的命令
...
### 22.Doit主题添加自定义shortcode

参考链接:[https://blog.233so.com/2020/04/friend-link-shortcodes-for-hugo-loveit/](https://blog.233so.com/2020/04/friend-link-shortcodes-for-hugo-loveit/)
